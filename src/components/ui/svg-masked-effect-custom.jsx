...
export const MaskContainer = ({
  ...
  return (
    ...
    >
      <motion.div
        className="w-full h-full flex items-center justify-center text-6xl absolute z-[5] bg-black bg-grid-white/[0.2] text-white [mask-image:url(/mask.svg)] [mask-size:40px] [mask-repeat:no-repeat]"
        animate={{
